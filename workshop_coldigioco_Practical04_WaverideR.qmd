---
title: "Time-Series Analysis of Paleoclimate Signals – Practical 04"
title-block-banner: "darkturquoise"
subtitle: |
  Basics on WaverideR <br>
  Coldigiocco Cyclonet Summer School 2025<br>
  by C. Zeeden, M. Crucifix, A.C. Da Silva
author: "Michiel Arts & Anne-Christine Da Silva"
date: today
...
A wavelet is truncated sine waves with N number of cycles contained within just like a windowed Fast Fourier analysis like the EHA function of 'astrochron' is is possible to track changing periods in the depth domain
...
Classically when working in R, the function dev_new is set to TRUE, which means that R opens a new plotting window to plot the plot, this guarantees a "nice" looking plot. However when running an R Quarto chunck, to allow plotting it needs to be set to dev_new = FALSE; but the plots are of lower quality. If you transfer this code to R, set dev_new to TRUE. 
:::
