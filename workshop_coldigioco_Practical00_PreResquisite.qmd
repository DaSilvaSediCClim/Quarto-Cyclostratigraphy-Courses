...
How to proceed with these files: <br />

1) open the html file and copy each window into R (there is a copy past button),  <br />

2) open the Quarto (.qmd) file into R and then you can run each chunck directly into R. <br />

For this practical I would recommand that you use option 1 which will allow you to make your own code and to comment it as you want. 
:::
...
It is important to have the latest version of R, so please upgrade if you have an older version. <br />
...
NOTE: for Windows, this binary will be located in the directory ‘base’. <br />

(2) Click on the downloaded file to install, and follow the instructions.

When installing, use all defaults. <br />
...
4.  Output Pane (bottom-right): This pane provides access to various tools and information, typically including:
    ...
    *Files*: Displays the files and directories within your current working directory. <br />
    *Plots*: Shows any plots you've generated during your R session. <br />
    *Packages*: Helps manage installed R packages, allowing you to install, update, or load them. <br />
    *Help*: Provides access to the extensive R documentation and help files. Viewer: Displays local web content generated by R. <br />
:::
...
require(devtools)
install_github('mcrucifix/gtseries@v1.4.0')
```
