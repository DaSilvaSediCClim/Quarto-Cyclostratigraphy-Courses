...
Stratigrapher allows you to build lithologs and to plot your log on the side of your proxies and of your spectral analysis results (Wouters et al., 2021).
...
![Structure of the dataframe to build a litholog in StratigrapheR](StratigrapheR_03.png){fig-align="center" width="569"}
...
## Creating a hardness curve evolution.
...
## Creating a facies curve evolution
...
## Plotting litholog with proxies
